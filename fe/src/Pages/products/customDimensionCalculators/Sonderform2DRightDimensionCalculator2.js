...
function Sonderform2DRightDimensionCalculator2({measurementUrl, dimensions, setDimensions}) {
    useEffect(() => {
    ...
    return (
        <div>
            ...
            <div>
                <CenterImage style={{ margin: "auto"}} src={SonderformImage} alt={"sonderform sample image for dimensions"}/>
                <FlexBoxWrapper>
                    <SingleMeasurementInput
...
export default Sonderform2DRightDimensionCalculator2;
