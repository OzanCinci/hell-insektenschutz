...
function Sonderform3DDimensionCalculator({measurementUrl, dimensions, setDimensions}) {
        ...
        <div>
            ...
            <div>
                <FlexBoxWrapper>
                    ...
                    />
                    <CenterImage src={Sonderform3dImage} alt={"sonderform sample image for dimensions"} />
                    <SingleMeasurementInput
                        title=""
                        inputWidth={100}
...
export default Sonderform3DDimensionCalculator;
